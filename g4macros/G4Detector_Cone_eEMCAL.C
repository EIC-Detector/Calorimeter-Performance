...
/* Electron-going Crystal Calorimeter (EMCAL)
 ...
 */
double G4Detector_Cone_eEMCAL(PHG4Reco* g4Reco, double zpos, const double etamin, const double etamax, const double thickness)
{
