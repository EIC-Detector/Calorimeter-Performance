			   ...
			   )
{
  ...
  cout << "Run Fun4All_G4_FHCAL_ZeroField with... " << endl;
  ...
  //----------------------
  G4CaloShowerAnalysis* showerAnalysis = new G4CaloShowerAnalysis( "G4Shower_FHCAL" , "G4Shower_FHCAL.root" );
  showerAnalysis->AddG4HitNode("G4HIT_FHCAL");
  showerAnalysis->SetStoreESum( true , 2001 , -0.005 , 20.005 );

  se->registerSubsystem(showerAnalysis);

  G4CaloShowerAnalysis* showerAnalysisAbsorber = new G4CaloShowerAnalysis( "G4Shower_Abs_FHCAL" , "G4Shower_Abs_FHCAL.root" );
  showerAnalysisAbsorber->AddG4HitNode("G4HIT_ABSORBER_FHCAL");
  ...
  //----------------------
  CaloTowerBuilderForwardHcal* tower_FHCAL = new CaloTowerBuilderForwardHcal();
  ...
  //----------------------
  G4CaloTowerAnalysis* towerAnalysis = new G4CaloTowerAnalysis( "TowerAna_FHCAL" , "TowerAna_FHCAL.root" );
  towerAnalysis->AddTowerNode("TOWER_FHCAL");
